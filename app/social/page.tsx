...
export default function SocialPage() {
  return (
    <main className="shell">
      ...
      <section className="social-page reveal-in">
        <div className="eyebrow">Follow the project</div>
        <h1 className="display-title">SOCIAL</h1>
        <div className="social-list">
          {socials.map(([name, url, desc], i) => (
            <a className="social-row" key={name} href={url}>
              <span className="social-no">0{i + 1}</span>
